...
Tag range: `v0.226.0..v0.226.1`.

### Bug Fixes

- **telemetry**: scope event provenance
- **daemon**: normalize owner transport errors
- **daemon**: fence dispatching owner jobs
- **daemon**: close owner metrics fences
- **daemon**: fence expired owner jobs
...
Tag range: `v0.221.8..v0.221.9`.

### Bug Fixes

- **daemon**: reuse shared recall accessor
- enumerate macOS transcript directories by fd
- use descriptor-relative macOS transcript paths
- close migration schema probes
- retry transcript upload finalization
- make transcript uploads resilient at scale
- support resumable transcript imports on Windows
...
Tag range: `v0.221.6..v0.221.7`.

### Bug Fixes

- **retention**: simplify portable purge
- **retention**: bounded deletes portable to SQLite without DELETE LIMIT

## [0.221.6] - 2026-09-07

Release summary: 1 bug fix.
Tag range: `v0.221.5..v0.221.6`.

### Bug Fixes

- **ci**: build core before website deploy

## [0.221.5] - 2026-09-07

Release summary: 2 bug fixes.
Tag range: `v0.221.4..v0.221.5`.

### Bug Fixes

- **release**: remove private Pi dependency
- **dreaming**: await token worker teardown

## [0.221.4] - 2026-09-07

Release summary: 2 bug fixes and 2 refactors.
Tag range: `v0.221.3..v0.221.4`.

### Bug Fixes

- **daemon**: isolate source worker runtime
- **daemon**: align DB audit call sites

### Refactoring

- **daemon**: remove dead source worker commands
- **daemon**: share integrity child lifecycle

## [0.221.3] - 2026-09-07

Release summary: 1 bug fix.
Tag range: `v0.221.2..v0.221.3`.

### Bug Fixes

- **desktop**: preserve concurrent resources (#1886)

## [0.221.2] - 2026-09-07

Release summary: 1 bug fix.
Tag range: `v0.221.1..v0.221.2`.

### Bug Fixes

- **daemon**: reject missing macOS Python (#1885)
...
Release summary: 1 feature.
Tag range: `v0.220.0..v0.221.0`.

### Features

- **install**: make Windows a first-class install target (#1881)
...
Release summary: 1 bug fix.
Tag range: `v0.219.4..v0.219.5`.

### Bug Fixes

- **hooks**: skip install without git
...
Release summary: 1 bug fix.
Tag range: `v0.219.2..v0.219.3`.

### Bug Fixes

- **core**: allow undeclared tool capability
...
Tag range: `v0.218.0..v0.219.0`.

### Features

- replace terminal setup with guided dashboard onboarding

### Bug Fixes

- keep installer loading out of daemon boot and repair CI gates
- integrate onboarding with updated dashboard
- unblock onboarding review and use existing brand assets

## [0.218.0] - 2026-09-05

Release summary: 1 feature.
Tag range: `v0.217.3..v0.218.0`.

### Features

- **dashboard**: refine workspace and icon system

## [0.217.3] - 2026-09-05

Release summary: 1 refactor.
Tag range: `v0.217.2..v0.217.3`.

### Refactoring

- **setup**: make source cloning explicit
...
Release summary: 3 bug fixes.
Tag range: `v0.217.0..v0.217.1`.

### Bug Fixes

- **memory**: fence profile memory before applying context budgets
- **memory**: read entries only from the current head revision
- **memory**: fence generated heads by agent and source revision
...
Release summary: 1 bug fix.
Tag range: `v0.214.45..v0.214.46`.

### Bug Fixes

- **daemon**: bundle Dreaming finalizer
